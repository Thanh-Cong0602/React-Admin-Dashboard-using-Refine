...
import type { UpdateUserMutation, UpdateUserMutationVariables } from '@/graphql/types';
...
export const AccountSettings = ({ opened, setOpened, userId }: Props) => {
  const {
    ...
    formProps,
    query: queryResult,
  } = useForm<GetFields<UpdateUserMutation>, HttpError, GetVariables<UpdateUserMutationVariables>>({
