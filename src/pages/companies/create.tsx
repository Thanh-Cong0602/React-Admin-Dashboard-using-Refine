...
import { CREATE_COMPANY_MUTATION, USERS_SELECT_QUERY } from '@/graphql/queries';
...
export const Create = () => {
  ...
  return (
    <CompanyList>
      <Modal {...modalProps} mask={true} onCancel={goToListPage} title="Add new company" width={512}>
