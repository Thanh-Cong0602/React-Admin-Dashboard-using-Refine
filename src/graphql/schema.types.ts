...
export type AuditSortFields = 'action' | 'createdAt' | 'id' | 'targetEntity' | 'targetId' | 'updatedAt';
...
export type EventCategorySortFields = 'createdAt' | 'id' | 'title' | 'updatedAt';
...
export type QuoteSortFields = 'createdAt' | 'id' | 'status' | 'title' | 'total' | 'updatedAt';
